...
from eventflow.schemas import DependencyMap, Playbook, RawSignal
...
def build_eventflow_graph(
    ...
    """Compile the M3 EventFlow StateGraph."""
    ...
    graph.add_node(
        "retrieve_evidence",
        make_retrieve_evidence_node(dependency_map, playbooks),
    )
...
def run_graph_for_signal(
    ...
    """Run one RawSignal through the compiled M3 graph."""
